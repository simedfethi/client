...
describe('TransportUnit Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'transport-unit', component: TransportUnitComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transportUnits?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to transportUnitService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTransportUnitIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTransportUnitIdentifier).toHaveBeenCalledWith(entity);

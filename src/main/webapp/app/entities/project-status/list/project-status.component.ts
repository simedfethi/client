...
import { EntityArrayResponseType, ProjectStatusService } from '../service/project-status.service';
...
export class ProjectStatusComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProjectStatus): number => this.projectStatusService.getProjectStatusIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.projectStatuses = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProjectStatus[] | null): IProjectStatus[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.projectStatusService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }

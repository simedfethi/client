...
describe('ProjectStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'project-status', component: ProjectStatusComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.projectStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to projectStatusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProjectStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProjectStatusIdentifier).toHaveBeenCalledWith(entity);

...
describe('Monnaie Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'monnaie', component: MonnaieComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.monnaies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to monnaieService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMonnaieIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMonnaieIdentifier).toHaveBeenCalledWith(entity);

...
import { EntityArrayResponseType, MonnaieService } from '../service/monnaie.service';
...
export class MonnaieComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMonnaie): number => this.monnaieService.getMonnaieIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.monnaies = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IMonnaie[] | null): IMonnaie[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.monnaieService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }

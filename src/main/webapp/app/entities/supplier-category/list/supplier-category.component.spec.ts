...
describe('SupplierCategory Management Component', () => {
  let comp: SupplierCategoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'supplier-category', component: SupplierCategoryComponent }]),
      ...
      .overrideTemplate(SupplierCategoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.supplierCategories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to supplierCategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSupplierCategoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSupplierCategoryIdentifier).toHaveBeenCalledWith(entity);

...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../email-template.test-samples';

import { EmailTemplateService, RestEmailTemplate } from './email-template.service';

const requireRestSample: RestEmailTemplate = {
...
describe('EmailTemplate Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a EmailTemplate', () => {
      ...
      const emailTemplate = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(emailTemplate).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a EmailTemplate', () => {
      const emailTemplate = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(emailTemplate).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addEmailTemplateToCollectionIfMissing', () => {
      it('should add a EmailTemplate to an empty array', () => {
        const emailTemplate: IEmailTemplate = sampleWithRequiredData;
      ...
      it("should add a EmailTemplate to an array that doesn't contain it", () => {
        const emailTemplate: IEmailTemplate = sampleWithRequiredData;
        const emailTemplateCollection: IEmailTemplate[] = [sampleWithPartialData];
        expectedResult = service.addEmailTemplateToCollectionIfMissing(emailTemplateCollection, emailTemplate);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(emailTemplate);
      });
      ...
      it('should add only unique EmailTemplate to an array', () => {
        const emailTemplateArray: IEmailTemplate[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const emailTemplateCollection: IEmailTemplate[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const emailTemplate: IEmailTemplate = sampleWithRequiredData;
        const emailTemplate2: IEmailTemplate = sampleWithPartialData;
    ...
    describe('compareEmailTemplate', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareEmailTemplate(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareEmailTemplate(entity1, entity2);
        const compareResult2 = service.compareEmailTemplate(entity2, entity1);

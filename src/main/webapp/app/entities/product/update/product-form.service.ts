...
type ProductFormDefaults = Pick<NewProduct, 'id' | 'productvariantes'>;
...
type ProductFormGroupContent = {
  ...
  categorie: FormControl<IProduct['categorie']>;
  productvariantes: FormControl<IProduct['productvariantes']>;
};
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      categorie: new FormControl(productRawValue.categorie),
      productvariantes: new FormControl(productRawValue.productvariantes ?? []),
    });
  }
